...
function CreateCategory() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://localhost:7113/api/Category', {
        name: name
      });
        ...
        <div className="row">
          <div className="col-md-12 d-flex align-items-center stretch-card">
            <div className="d-flex justify-content-between align-items-center w-100">
              ...
              <Link to='/Admin/Categories/ListCategories' className='btn section-btn btn-custom'>View Categories</Link>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-8 offset-2 align-items-center stretch-card">
          <div className="card shadow border-0 rounded-lg mt-5">
            <div className="card-header">
              <h2 className="text-center font-weight-bold p-4 Bricolage-font">Add Category</h2>
            </div>
