...
function EditTag() {
    ...
    useEffect(() => {
        axios.get(`https://localhost:7113/api/Tags/${id}`)
            .then(res => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://localhost:7113/api/Tags/${id}`, {
                id,
                name
            });
                ...
                <div className="col-md-8 offset-2 align-items-center stretch-card">
                    <div className="card shadow border-0 rounded-lg mt-5">
                        <div className="card-header">
                            <h2 className="text-center font-weight-bold p-4 Bricolage-font">Update Tags</h2>
                        </div>
